...
export class PreloaderScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // District map + ground atlas (generated by scripts/build-district.mjs)
    ...
    // Interiors: maps, atlas, furniture, animated objects
  ...
  private registerAgentAnimations() {
    ...
    // Status icons — two-frame pulsing
