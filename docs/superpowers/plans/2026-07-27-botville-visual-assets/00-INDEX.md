...
**Three tasks need the licensed packs — 3, 20 and 39 — and all three live in Plan 6.** Everything else, including the appearance composer and the whole deployment story, runs without a licensed pixel.
...
```bash
npm run bake:agents -- --roster roster/roster.json
